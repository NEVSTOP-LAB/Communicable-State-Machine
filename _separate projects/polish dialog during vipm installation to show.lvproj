...
<Project Type="Project" LVVersion="17008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="_csm_user_lib_dir.vi" Type="VI" URL="../../src/user.lib/_NEVSTOP/Communicable State Machine(CSM)/_scripts/_csm_user_lib_dir.vi"/>
			<Item Name="_script_fix_exclude event case ref check.vi" Type="VI" URL="../../src/user.lib/_NEVSTOP/Communicable State Machine(CSM)/_scripts/_script_fix_exclude event case ref check.vi"/>
			<Item Name="_script_fix_Find Event Stucture Ref vi.vi" Type="VI" URL="../../src/user.lib/_NEVSTOP/Communicable State Machine(CSM)/_scripts/_script_fix_Find Event Stucture Ref vi.vi"/>
			<Item Name="_script_fix_list event frames.vi" Type="VI" URL="../../src/user.lib/_NEVSTOP/Communicable State Machine(CSM)/_scripts/_script_fix_list event frames.vi"/>
			<Item Name="_script_fix_Parse State Queue in Find Parse State Queue vi name.vi" Type="VI" URL="../../src/user.lib/_NEVSTOP/Communicable State Machine(CSM)/_scripts/_script_fix_Parse State Queue in Find Parse State Queue vi name.vi"/>
			<Item Name="_script_fix_Parse State Queue in Find Parse State Queue vi name2.vi" Type="VI" URL="../../src/user.lib/_NEVSTOP/Communicable State Machine(CSM)/_scripts/_script_fix_Parse State Queue in Find Parse State Queue vi name2.vi"/>
			<Item Name="_script_fix_vi broken in Tree__JKI_State_Machine_Helper.vi" Type="VI" URL="../../src/user.lib/_NEVSTOP/Communicable State Machine(CSM)/_scripts/_script_fix_vi broken in Tree__JKI_State_Machine_Helper.vi"/>
