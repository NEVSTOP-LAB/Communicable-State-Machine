...
<Library LVVersion="17008000">
	...
	<Item Name="_Client" Type="Folder">
		<Item Name="Simple TCP - Client.vi" Type="VI" URL="../Simple TCP - Client.vi"/>
	</Item>
	<Item Name="_support" Type="Folder">
		<Item Name="_Clear Network 56 Error.vi" Type="VI" URL="../_Clear Network 56 Error.vi"/>
	</Item>
	<Item Name="SubModules" Type="Folder">
		<Item Name="TCP Server Module(Multi-Loop Support).vi" Type="VI" URL="../TCP Server Module(Multi-Loop Support).vi"/>
	</Item>
	<Item Name="TopVI" Type="Folder">
		<Item Name="Main - Call and Monitor TCP Traffic.vi" Type="VI" URL="../Main - Call and Monitor TCP Traffic.vi"/>
	</Item>
</Library>
