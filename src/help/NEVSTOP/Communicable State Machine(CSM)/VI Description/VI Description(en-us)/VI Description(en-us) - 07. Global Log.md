...
This is a Subscriber-side filtering VI used to determine if a log satisfies the filtering rules. The filtering judgment occurs at the subscriber end, so it will not affect subscriptions of other tools.
