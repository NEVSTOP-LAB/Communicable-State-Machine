...
> - Build Interrupt Status Message.vi: Concatenates and generates CSM interrupt broadcast strings.
...
```
  ...
  // The following strings are equivalent operations. More operation characters are defined for easier typing and memorization.
...
```
  ...
  Example: Bind the "Download Finished" message of the Downloader module to the "Start Play" API of the Player module.
        ...
        // When multiple modules have the "Download Finished" message, use * to bind this message from all modules to the "Start Play" API of the Player module
